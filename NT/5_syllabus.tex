...
\usepackage[style=authoryear-ibid,sorting=nyt,sortcites=true,autopunct=true,babel=hyphen,hyperref=true,abbreviate=false,backref=true,backend=biber]{biblatex}
...
\begin{itemize}
    ...
    \item \fullcite{hatch1951facsimiles}
\end{itemize}
